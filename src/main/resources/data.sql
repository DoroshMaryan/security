INSERT IGNORE INTO `spring_security`.`user` (`id`, `username`, `password`, `algorithm`) VALUES ('1', 'john', '{BCRYPT}$2a$10$Ev8DTnRoA4DfuAn7tbge5OvTjtFYIv8pc7IEL26WRJfEiHDjxVc56', 'BCRYPT');
